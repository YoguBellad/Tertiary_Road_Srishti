...
void sms()
{
  ...
  {
msg="SIGNAL JUMP ,pay penalty of Rs.100  http://27.7.131.71/dashboard/RULE_VIOLATION.png";
      
   // if (!(msg.equals(m2)))
  {  
    //msg="SIGNAL JUMP ,pay penalty of Rs.100  http://localhost/dashboard/RULE_VIOLATION.png";
      mySerial.println("AT"); 
      delay(1000);
